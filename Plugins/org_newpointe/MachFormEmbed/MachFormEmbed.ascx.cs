...
namespace RockWeb.Plugins.org_newpointe.MachFormEmbed
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        //Generate Form Javascript
            ...
            <script type='text/javascript' src='https://forms.websbyjay.us/js/jquery.ba-postmessage.min.js'></script>
            <script type='text/javascript' src='https://forms.websbyjay.us/js/machform_loader.js'></script>", ServerRoot, FormID, MFParamaters, Height);
    }
