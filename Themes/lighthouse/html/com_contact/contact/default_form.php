...
<form class="contact-form submission box style" action="<?php echo JRoute::_('index.php'); ?>" method="post" id="contact-form">
	<fieldset>
	...
	<div class="submit">
		<button class="button validate uk-button uk-button-color" type="submit"><?php echo JText::_('COM_CONTACT_CONTACT_SEND'); ?></button>
	</div>
