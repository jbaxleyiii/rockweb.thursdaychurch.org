...
<div id="system" itemscope itemtype="http://schema.org/Person">
	...
	<div class="item">
		...
		<h1 class="title" itemprop="name"><?php echo $this->contact->name; ?></h1>
		<?php endif;  ?>
		
		<?php if ($this->contact->con_position && $this->params->get('show_position')) : ?>
		<h2 class="subtitle" itemprop="jobTitle"><?php echo $this->contact->con_position; ?></h2>
		<?php endif; ?>
		...
		<?php if ($this->contact->misc && $this->params->get('show_misc')) : ?>
			<h2 class="subtitle"><?php echo JText::_('COM_CONTACT_OTHER_INFORMATION'); ?></h2>
			<p><?php echo $this->contact->misc; ?></p>
		<?php endif; ?>

		<?php if ($this->params->get('show_links')) : ?>
			<h1 class="module-title"><?php echo JText::_('COM_CONTACT_LINKS'); ?></h1>
			<?php echo $this->loadTemplate('links'); ?>
		<?php endif; ?>

		<?php if ($this->params->get('show_articles') && $this->contact->user_id && $this->contact->articles) : ?>
			<h1 class="module-title"><?php echo JText::_('JGLOBAL_ARTICLES'); ?></h1>
			<?php echo $this->loadTemplate('articles'); ?>
		<?php endif; ?>

		<?php if ($this->params->get('show_profile') && $this->contact->user_id && JPluginHelper::isEnabled('user', 'profile')) : ?>
			<h1 class="module-title"><?php echo JText::_('COM_CONTACT_PROFILE'); ?></h1>
			<?php echo $this->loadTemplate('profile'); ?>
		<?php endif; ?>

		<?php if ($this->params->get('show_email_form') && ($this->contact->email_to || $this->contact->user_id)) : ?>
			<h1 class="module-title"><?php  echo JText::_('COM_CONTACT_EMAIL_FORM'); ?></h1>
