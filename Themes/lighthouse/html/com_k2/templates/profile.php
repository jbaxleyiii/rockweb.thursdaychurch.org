...
<form action="<?php echo JURI::root(true); ?>/index.php" enctype="multipart/form-data" method="post" name="userform" autocomplete="off" class="form-validate">
	...
	<div class="componentheading<?php echo $this->escape($this->params->get('pageclass_sfx')); ?>">
		<h1 class="module-title"><?php echo $this->escape($this->params->get('page_title')); ?></h1>
	</div>
	<?php endif; ?>
		...
		<table class="admintable" cellpadding="0" cellspacing="0">
			<tr>
				<th colspan="2" class="k2ProfileHeading">
					<h3 class="underline"><?php echo JText::_('K2_ACCOUNT_DETAILS'); ?></h3>
				</th>
			</tr>
			<tr>
				<td class="key">
			...
			<tr>
				<th colspan="2" class="k2ProfileHeading">
					<h3 class="underline"><?php echo JText::_('K2_PERSONAL_DETAILS'); ?></h3>
				</th>
			</tr>
			<!-- K2 attached fields -->
			<tr>
			...
			<tr>
				<th colspan="2" class="k2ProfileHeading">
					<h3 class="underline"><?php echo JText::_('K2_ADDITIONAL_DETAILS'); ?></h3>
				</th>
			</tr>
			...
			<tr>
				<th colspan="2" class="k2ProfileHeading">
					<h3 class="underline"><?php echo JText::_('K2_ADMINISTRATIVE_DETAILS'); ?></h3>
				</th>
			</tr>
			<tr>
			...
			<?php foreach ($this->form->getFieldsets() as $fieldset): // Iterate through the form fieldsets and display each one.?>
				...
				<?php if (count($fields)):?>
					...
					<tr>
						<th colspan="2" class="k2ProfileHeading">
							<h3 class="underline"><?php echo JText::_($fieldset->label);?></h3>
						</th>
					</tr>
					<?php endif;?>
