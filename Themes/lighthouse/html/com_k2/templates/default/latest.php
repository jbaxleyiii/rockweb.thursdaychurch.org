	...
	<header>
  	...
  	<div class="itemsContainer">
    	...
    	<?php if($this->source=='categories'): $category=$block; ?>
	    	...
	    	<a class="k2FeedIcon uk-icon-rss" href="<?php echo $category->feed; ?>"> <?php echo JText::_('K2_SUBSCRIBE_TO_THIS_RSS_FEED'); ?></a>
	    	<?php endif; ?>
    	<?php endif; ?>
    <?php else: $user=$block; ?>
	    ...
	    <div class="itemAuthorBlock uk-panel uk-panel-box">
	        ...
	        <div class="gkAvatar">
	        	<img class="uk-round-avatar" src="<?php echo $user->avatar; ?>" alt="<?php echo $user->name; ?>" style="width:<?php echo $this->params->get('userImageWidth'); ?>px;height:auto;" />
	        </div>
	        <?php endif; ?>
	        
	        <div class="itemAuthorDetails" itemprop="author" itemscope itemtype="http://schema.org/Person">
		        <?php if ($this->params->get('userName')): ?>
		        <h3 itemprop="name"><a rel="author" href="<?php echo $user->link; ?>"><?php echo $user->name; ?></a></h3>
		        <?php endif; ?>
	    ...
	    <a class="k2FeedIcon uk-rss-icon" href="<?php echo $user->feed; ?>"> <?php echo JText::_('K2_SUBSCRIBE_TO_THIS_RSS_FEED'); ?></a>
	    <?php endif; ?>
    <?php endif; ?>
    <?php endif; ?>
